...
import { ScrollView, Text, View, StyleSheet, ListView, Linking } from 'react-native';
...
export default class WorkScreen extends React.Component {
    ...
    constructor(props) {
      ...
      this.state = {alex: navigation.getParam('alex', '')};
    }
        ...
        <View style={styles.container}>
          ...
          <View style={[styles.workContainer, {flex: 1}]}>
            ...
            { alex.workExperience.map((work)=>(
              <View key={work.job + work.company} style={styles.tableContainerWork}>
